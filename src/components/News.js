...
export class News extends Component {
    ...
    async updateNews(page) {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apikey=a6af2a49112b4b3fbc537d4335a74426&page=${this.state.page}&pageSize=${this.props.pageSize}`
